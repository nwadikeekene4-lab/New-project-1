...
    <div className="admin-wrapper" style={{ padding: '20px' }}>
      ...
      {/* ✅ ADDED: Inline Styled Back Arrow only */}
      <Link to="/admin/dashboard" style={{ textDecoration: 'none', color: '#333', fontSize: '28px', display: 'inline-block', marginBottom: '10px', fontWeight: 'bold' }}>
        ←
      </Link>
...
              <button type="submit" className="add-btn" style={{ backgroundColor: '#4caf50' }}>
                + Add Product
              </button>
            </div>
          </form>
